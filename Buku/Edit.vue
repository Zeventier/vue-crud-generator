<template>
    <AppLayout title="Buku">
        ...
        <div class="container">
            <a class="btn btn-primary mb-3 mt-3" :href="route('admin.buku.index')"><font-awesome-icon
                    icon="fa-solid fa-arrow-left" /></a>
            <div class="container">
                <form @submit.prevent="form.put(route('admin.buku.update', buku.id))">
...
export default defineComponent({
    ...
    setup(props) {
        const form = useForm({
            __field__: props.buku.__field__,
        });
